...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('mfpayments', 'API\PaymentInvoiceAPIController@allPayments');
    Route::get('mfpayments/{id}', 'API\PaymentInvoiceAPIController@show');
    Route::delete('mfpayments/{id}', 'API\PaymentInvoiceAPIController@destroy');

    Route::post('payment/index', 'API\PaymentInvoiceAPIController@index');
    Route::get('payment/success_callback', 'API\PaymentInvoiceAPIController@successCallback');
    Route::get('payment/fail_callback', 'API\PaymentInvoiceAPIController@failCallback');
