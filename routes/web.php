...
Route::get('order/dummy', 'OrderController@dummy');
Route::post('payment/process', 'MyFatoorahController@process');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/mfpayments', 'MyFatoorahController@allPayments');
    Route::get('/mfpayments/{id}', 'MyFatoorahController@show');
    Route::delete('/mfpayments/{id}', 'MyFatoorahController@destroy');
});
